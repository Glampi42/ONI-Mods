...
namespace ChainErrand.ChainedErrandPacks {
   public class MoveToPack : AChainedErrandPack<Movable, ChainedErrand_Movable> {
      public override List<GPatchInfo> OnChoreCreate_Patch() {
         ...
         var targetMethod5 = typeof(MovePickupableChore.States).GetMethod("<InitializeStates>b__16_6", Utils.GeneralBindingFlags);// inner lambda expression inside of success.Enter([...]) inside of InitializeStates()
